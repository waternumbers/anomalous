...
\[
L\left(\mathbf{y}_{t} \left| \theta_k,\sigma_k,\mathbf{X}_{t}\right.\right) = 
\left(2\pi s_{t} \sigma_{k}\right)^{-n_{t}/2} 
\exp\left(-\frac{1}{2s_{t}\sigma_{k}}\left( \mathbf{y}_{t} - \mathbf{X}_{t} \mathbf{m}_{t} - \mathbf{X}_{t} \theta_{k}\right)^{\prime}\left( \mathbf{y}_{t}  - \mathbf{X}_{t} \mathbf{m}_{t} - \mathbf{X}_{t} \theta_{k}\right) \right)
\]
